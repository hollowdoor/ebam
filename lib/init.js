...
//const Prompts = require('./init/prompts.js');
...
`);
    /*prompts.addFields([
        ...
        {
          type    : 'confirm',
          name    : 'ebam.transforms.dangerousForOf',
          message : 'Enable buble dangerousForOf?',
          default : false
        },{
          type    : 'confirm',
          name    : 'ebam.transforms.dangerousTaggedTemplateString',
